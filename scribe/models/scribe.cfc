...
component extends="coldbox.system.logging.Logger" accessors="true" {
	...
	property name="rules"           inject="coldbox:setting:rules@scribe";
	property name="ruleDefinitions" inject="coldbox:setting:ruleDefinitions@scribe";
	property name="wirebox"         inject="wirebox";
	property name="scribeSettings"  inject="coldbox:moduleSettings:scribe";
	...
	property name="mandatoryKeys" inject="coldbox:setting:mandatoryKeys@scribe";
